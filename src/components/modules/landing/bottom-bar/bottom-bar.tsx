...
export default function BottomBar() {
  return (
    <div className="fixed bottom-0 left-0 w-full backdrop-blur-md bg-opacity-50 bg-white  dark:bg-black text-black md:hidden hidden">
      <div className="max-w-screen-lg mx-auto px-4 py-2 flex justify-between items-center">
        <Link href="/" className="w-full">
          <button className="darK:text-white py-2 px-4 hover:bg-gray-700 focus:outline-none focus:bg-gray-700 w-full flex flex-col justify-center items-center">
            <Database />
